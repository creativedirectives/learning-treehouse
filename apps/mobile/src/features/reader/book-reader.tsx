...
export function BookReader({ book, onBackToShelf }: Props) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.screen}>
      ...
      <View style={styles.pageCard}><Text style={styles.pageText}>{page.readAlong.text}</Text></View>
...
const styles = StyleSheet.create({
  ...
  pageCard: { backgroundColor: '#fff9ed', borderRadius: 24, marginTop: 28, padding: 26 }, pageText: { color: '#173b2b', fontSize: 32, fontWeight: '700', lineHeight: 44 },
